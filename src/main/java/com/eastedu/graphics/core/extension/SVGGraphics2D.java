package com.eastedu.graphics.core.extension;///* ===================================================
...
//package com.eastedu.graphics.core.extension;
//
//import com.eastedu.question.enums.AlignmentTypeEnum;
...
//
//    private AlignmentTypeEnum alignment;
//    /**
...
//    }
//
//    public void setAlignment(AlignmentTypeEnum alignment) {
...
//        }
//        Object attr = this.font.getAttributes().get(TextAttribute.SUPERSCRIPT);
//        if (Objects.nonNull(attr)) {
//            if (attr == TextAttribute.SUPERSCRIPT_SUB) {
//                b.append(" baseline-shift: sub;");
//            }
//            if (attr == TextAttribute.SUPERSCRIPT_SUPER) {
//                b.append(" baseline-shift: super;");
//            }
//
//        }
//        return b.toString();
//    }
//
//    private String getTextAlignStyle() {
////        StringBuilder b = new StringBuilder();
////        b.append("text-anchor: ").append(getAlignment().name().toLowerCase()).append("; ");
////        return b.toString();
//        return "";
//    }
//
...
//            this.sb.append(" style=\"").append(getSVGFontStyle());
//            this.sb.append(getTextAlignStyle()).append("\"");
...
//        b.append("<!DOCTYPE svg PUBLIC \"-//W3C//DTD SVG 1.1//EN\" ");
