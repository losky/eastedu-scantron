...
public class CompositeDecoratorRender {
    private final Map<UnderlineStyle, DecoratorRender> renderers = new HashMap<>();
    private final DecoratorRender emphasisDotRender = new EmphasisDotRender();
    private final DecoratorRender strikeRender = new StrikeRender();

    /**
     * Instantiates a new Composite underline render.
     */
    public CompositeDecoratorRender() {
     ...
     */
    public void draw(Graphics2D g2d, int x, int baseline, int width, int ascent, TextStyle style) {
